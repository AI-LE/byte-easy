...
//        strategy.setTablePrefix(pc.getModuleName() + "_");
        ...
        String expand = projectPath + File.separator + "byte-easy/src/main/resources/templates" + File.separator + pc.getModuleName()+File.separator;

        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                // 自定义Mapper.xml文件存放的路径
                return projectPath + "/byte-easy/src/main/resources/mybatis/mapper/"
        ...
        focList.add(new FileOutConfig("/generator/java/controller/controller.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                String expand = projectPath + File.separator + "templates" + File.separator + pc.getModuleName();
