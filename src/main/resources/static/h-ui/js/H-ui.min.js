...
function stopDefault(e) {
...
})(jQuery, window, document); (function(document, window, index) {
    ...
    function($) {
        $.fn.Huispinner = function(options) {
            ...
            this.each(function() {
                var that = $(this);
                var str = '<div class="spinner">' + '<a class="subtract disabled" href="javascript:void(0)"><i>-</i></a>' + '<input class="amount input-text" value="' + options.value + '" autocomplete="off">' + '<a class="add" href="javascript:void(0)"><i>+</i></a>' + "</div>";
                that.append(str);
                        ...
                        function(event) {
                            ...
                            if (type == _click) {
                                ...
                                if (type == "keydown" && key == 32) {
                                    ...
                                    if (type == "keyup" && node[_type] == _radio) { ! node[_checked] && on(self, _checked)
                                    } else {
                                        if (/us|ur/.test(type)) {
        ...
        init: function(settings) {
            return this.each(function() {
                ...
                if (self.opt.cancel) {
                    ...
                    if (self.opt.cancelPlace == "left") {} else {}
...
function displaynavbar(obj) {
    ...
    function($) {
        $.fn.Huitab = function(options) {
            ...
            this.each(function() {
                ...
                that.find(options.tabBar).on(options.tabEvent,
                    function() {
                        that.find(options.tabBar).removeClass(options.className);
    ...
    function($) {
        $.fn.Huifold = function(options) {
            ...
            this.each(function() {
                var that = $(this);
                that.find(options.titCell).on(options.trigger,
                    function() {
    ...
    function($) {
        $.fn.Huitags = function(options) {
            ...
            this.each(function() {
                ...
                $(document).on("click", ".Huitags-token",
                    function() {
                        $(this).remove();
                        var str = "";
                ...
                that.hover(function() {
                        ...
                        timer = setTimeout(function() {
                                ...
                                if (bigImg == "") {
                                    ...
                                    var tooltip_keleyi_com = '<div id="preview-wraper" style="position: absolute;width:' + options.bigImgWidth + "px;height:auto;top:" + imgT + "px;right:" + tooltipRight + ";left:" + tooltipLeft + '">' + '<img src="' + smallImg + '" width="' + options.bigImgWidth + '">' + "</div>";
    ...
    function($) {
        ...
        Modal.prototype.show = function(_relatedTarget) {
            ...
            this.backdrop(function() {
                ...
                transition ? that.$element.find(".modal-dialog").one("bsTransitionEnd",
                    function() {
        ...
        var Slider; (function($) {
            ...
            function createNewSlider(element, options) {
                ...
                if (updateSlider === true) {
                    ...
                    this._removeClass(this.tooltip_max, "hide"); ["left", "top", "width", "height"].forEach(function(prop) {
