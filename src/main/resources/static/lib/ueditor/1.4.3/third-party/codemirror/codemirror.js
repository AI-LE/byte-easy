...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            indentLine: operation(function(n, dir) {
                if (isLine(n)) indentLine(n, dir == null ? "smart" : dir ? "templates.admin.weiboqahistory.add" : "subtract");
            }),
        ...
        function indentLine(n, how) {
            if (!how) how = "templates.admin.weiboqahistory.add";
            if (how == "smart") {
            ...
            else if (how == "templates.admin.weiboqahistory.add") indentation = curSpace + options.indentUnit;
    ...
    var commands = CodeMirror.commands = {
        ...
        indentMore: function(cm) {cm.indentSelection("templates.admin.weiboqahistory.add");},
