...
SVGElement.prototype = {
	...
	*/
	...
	add: function (parent) {
		...
		fireEvent(this, 'templates.admin.weiboqahistory.add');
...
SVGRenderer.prototype = {
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		 ...
		 */
		addEvent(wrapper, 'templates.admin.weiboqahistory.add', getSizeAfterAdd);
		...
		return extend(wrapper, {
			 ...
			 */
			destroy: function () {
				removeEvent(wrapper, 'templates.admin.weiboqahistory.add', getSizeAfterAdd);
...
Highcharts.VMLElement = VMLElement = {
	...
	add: function (parent) {
		...
		// fire an event for internal hooks
		fireEvent(wrapper, 'templates.admin.weiboqahistory.add');
			...
			if (prop === 'fill') {
				...
				// Radial (circular) gradient
					...
					if (wrapper.added) {
						...
						addEvent(wrapper, 'templates.admin.weiboqahistory.add', applyRadialGradient);
					}
